...
<head>
    <title>book list-/book/books/${criteria.page!}</title>
<#include "../cssjs.ftl">
</head>
<body>
...
<#include "../top.ftl">
    ...
    <#include "../menu.ftl">
        <div class="col-sm-10 "> <!--center col-sm-10 start -->
            <form id="criteria" action="/book/books"
            ...
            <#if code??&&code!=1 >
                ...
                <div class="form-group margin-top-10">
                    <label class="control-label " for="authorId">
                    authorId
                    </label>
                    <div class="input-group ">
						<span class="input-group-addon "> <span
                        ...
                        <input name="authorId"
                               ...
                               value="${criteria.authorId!}"
                        />
                    </div>
                    <div class="input-error text-danger">
                    <@spring.valid  "authorId"/>
                    </div>
                </div><!--form-group end  -->
                <div class="form-group margin-top-10">
                ...
                <input type="hidden" name="releaseTimeOrder" id="releaseTimeOrder-pagination"
                       value="${criteria.releaseTimeOrder!}">
                <input type="hidden" name="authorIdOrder" id="authorIdOrder-pagination"
                       value="${criteria.authorIdOrder!}">
                </div>
                <div class="form-group margin-top-10">
        ...
        <div <#include "../pageDivAttr.ftl">>
            ...
            <#list items as item>
                <tr>
                    ...
                    <td>
                    <#if item.releaseTime??>
                        ${item.releaseTime?number_to_datetime?string(datetime_format)}
                    </#if>
                    </td>
                    <td>
                        ${item.authorId?c}
                    ...
                    <td>
                        <a href="/book/book/${item.id?c}"
                           onclick="deleteBookConfirm(this,'${item.id?c}');return false;"
                        >
...
<script type="text/javascript">
    ...
    deleteBook()
    {
        ...
        $.ajax({
            "url": "/book/book/" + id, "success": function (resp) {
    ...
    function deleteBookConfirm(obj, id) {
        ...
        $("#confirm .modal-footer .btn-success").on("click", deleteBook);
    }
