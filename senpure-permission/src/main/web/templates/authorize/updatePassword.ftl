...
<#include "../top.ftl">
    ...
    <#include "../menu.ftl">
        <div class="col-sm-10 ">
            <form class="form-horizontal " action="/authorize/account/${accountId}/password" method="post"
                  autocomplete="false"
                  modal-form="true">
                ...
                <div class="form-group form-group-lg">
                    <label for="name" class="col-sm-2 control-label"><@spring.message code="label.password" /></label>
